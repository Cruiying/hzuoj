...
!function (e) {
    ...
    var n = function () {
        ...
        return t.prototype._createIgnoreDuplicateModulesMap = function () {
            ...
            this.sortedPathsRules = [], e.Utilities.forEachProperty(this.options.paths, (function (e, r) {
                Array.isArray(r) ? t.sortedPathsRules.push({from: e, to: r}) : t.sortedPathsRules.push({
                    from: e,
                    to: [r]
                })
    ...
    var t = function () {
        ...
        return e.prototype.load = function (e, t, i, s) {
            ...
            this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(d) : (this._callbackMap[t] = [d], this._scriptLoader.load(e, t, (function () {
        ...
        return t.prototype._init = function (e) {
            ...
            if (r && !this._didPatchNodeRequire) {
                ...
                var n = this, o = e("module");
                o.prototype._compile = function (e, i) {
                    var s, a = o.wrap(e.replace(/^#!.*/, "")), d = t.getRecorder(), u = n._getCachedDataPath(r, i),
                        l = {filename: i};
                    try {
                        var c = n._fs.readFileSync(u);
                        s = c.slice(0, 16), l.cachedData = c.slice(16), d.record(60, u)
                    } catch (e) {
                        d.record(61, u)
                    }
                    var h = new n._vm.Script(a, l), f = h.runInThisContext(l), p = n._path.dirname(i),
                        _ = function (e) {
                            var t = e.constructor, r = function (t) {
                                try {
                                    return e.require(t)
                                } finally {
                                }
                        ...
                        }(this), g = [this.exports, _, this, i, p, process, _commonjsGlobal, Buffer],
                        v = f.apply(this.exports, g);
                    return n._handleCachedData(h, a, u, !l.cachedData, t), n._verifyCachedData(h, a, u, s), v
                }
            }
        }, t.prototype.load = function (r, n, o, i) {
            var s = this, a = r.getConfig().getOptionsLiteral(), d = a.nodeRequire || e.global.nodeRequire,
            ...
            if (/^node\|/.test(n)) {
                ...
                var f = this._path.normalize(n), p = this._getElectronRendererScriptPathOrUri(f),
                    _ = Boolean(a.nodeCachedData), g = _ ? this._getCachedDataPath(a.nodeCachedData, n) : void 0;
                this._readSourceAndCachedData(f, g, l, (function (e, n, a, d) {
                    if (e) i(e); else {
                        ...
                        var c = {filename: p, cachedData: a}, h = s._createAndEvalScript(r, l, c, o, i);
                        s._handleCachedData(h, l, g, _ && !a, r), s._verifyCachedData(h, l, g, d)
                    }
                }))
            }
            ...
            var a = new this._vm.Script(r, n), d = a.runInThisContext(n), u = t.getGlobalAMDDefineFunc(), l = !1,
                c = function () {
                    return l = !0, u.apply(null, arguments)
                };
            return c.amd = u.amd,
                d.call(e.global, t.getGlobalAMDRequireFunc(), c, n.filename, this._path.dirname(n.filename)), s.record(32, n.filename), l ? o() : i(new Error("Didn't receive define call in " + n.filename + "!")), a
            ...
            var o = this,
                ...
                s = -1, a = 0, d = void 0, u = function () {
                    setTimeout((function () {
                        d || (d = o._crypto.createHash("md5").update(t, "utf8").digest());
                        var i = e.createCachedData();
                        0 === i.length || i.length === s || a >= 5 || (s = i.length, o._fs.writeFile(r, Buffer.concat([d, i]), (function (e) {
            ...
            if (t) {
                var o = void 0, i = void 0, s = void 0, a = 2, d = function (e) {
                    e ? n(e) : 0 == --a && n(void 0, o, i, s)
                };
                this._fs.readFile(e, {encoding: "utf8"}, (function (e, t) {
                    o = t, d(e)
                })), this._fs.readFile(t, (function (e, n) {
                    !e && n && n.length > 0 ? (s = n.slice(0, 16), i = n.slice(16), r.record(60, t)) : r.record(61, t), d()
                }))
            } else this._fs.readFile(e, {encoding: "utf8"}, n)
        }, t.prototype._verifyCachedData = function (e, t, r, n) {
            var o = this;
            n && (e.cachedDataRejected || setTimeout((function () {
                var e = o._crypto.createHash("md5").update(t, "utf8").digest()
                ;n.equals(e) || (console.warn("FAILED TO VERIFY CACHED DATA. Deleting '" + r + "' now, but a RESTART IS REQUIRED"), o._fs.unlink(r, (function (e) {
                    return console.error("FAILED to unlink: '" + r + "'", e)
                })))
    ...
    var r = function () {
        ...
        return t._safeInvokeFunction = function (t, r) {
            ...
            if (i) {
                ...
                a.phase = "factory", a.moduleId = this.strId, this.error = a, n.onError(a)
            }
    ...
    var s = function () {
        ...
        return s.prototype.reset = function () {
            ...
            for (var r = function (e) {
                ...
                var s = o[i].match(/(.*):(\d+):(\d+)\)?$/);
                if (s) {
                    var a = s[1], d = s[2], u = s[3], l = Math.max(a.lastIndexOf(" ") + 1, a.lastIndexOf("(") + 1);
            ...
            for (var e = [], t = 0, r = 0, n = this._modules2.length; r < n; r++) {
                ...
                if (o) {
                    ...
                    e[t++] = {
                        id: o.strId, path: i, defineLocation: i && a ? s._findRelevantLocationInStack(i, a) : null,
                        dependencies: d, shim: null, exports: o.exports
                    }
                }
            }
            return e
            ...
            var r = e.indexOf("!");
            if (r >= 0) {
                var n = t.resolveModule(e.substr(0, r)), s = t.resolveModule(e.substr(r + 1)),
                    a = this._moduleIdProvider.getModuleId(n + "!" + s), d = this._moduleIdProvider.getModuleId(n);
                return new i(a, d, s)
            }
            ...
            void 0 === r && (r = new t(e))
            ;var n = this._normalizeDependency(e, r), o = this._modules2[n.id];
            ...
            var n = this, o = this._moduleIdProvider.getStrModuleId(t),
            ...
            if (!this._modules2[e] && !this._knownModules2[e]) {
                ...
                var o = -1, i = function (r) {
                    if (++o >= n.length) t._onLoadError(e, r); else {
                        ...
                        a.record(10, s), t._scriptLoader.load(t, s, (function () {
                            t._config.isBuild() && (t._buildInfoPath[e] = s), a.record(11, s), t._onLoad(e)
                        }), (function (e) {
                            a.record(12, s), i(e)
                        }))
                    }
            ...
            if (r) for (var n = 0, s = r.length; n < s; n++) {
                var a = r[n];
            ...
            if (!e.isComplete()) {
                var n = e.dependencies, i = [];
                if (n) for (var s = 0, a = n.length; s < a; s++) {
                    var d = n[s];
                    if (d !== o.EXPORTS) if (d !== o.MODULE) if (d !== o.REQUIRE) {
                        var u = this._modules2[d.id];
                ...
                if (this._inverseDependencies2[e.id] = null, l) for (s = 0, a = l.length; s < a; s++) {
                    var c = l[s], h = this._modules2[c];
                ...
                if (f) {
                    ...
                    for (s = 0, a = f.length; s < a; s++) this._loadPluginDependency(e.exports, f[s])
                }
            }
        }, s
    }();
    ...
    var t = new e.Environment, r = null, n = function (e, t, n) {
